...
namespace VolvoWrench.DemoStuff.Source
{
    ...
    public class SourceParser
    {
        ...
        private void Parse()
        {
            ...
            if (Encoding.ASCII.GetString(id) != "HL2DEMO\0") Info.ParsingErrors.Add("Source parser: Incorrect mw");
            ...
            while (true)
            {
                ...
                if (msg.Type == MessageType.Stop) break;
                ...
                if (msg.Data != null)
                        ...
                        Encoding.ASCII.GetString(msg.Data).Contains("autosave"))
                    {
                        ...
                        if (Encoding.ASCII.GetString(msg.Data).Contains("#SAVE#")) tempf.Name = "#SAVE#";

                        if (Encoding.ASCII.GetString(msg.Data).Contains("autosave")) tempf.Name = "autosave";
